export default [
  {
    schema: {
      ...
      description: "Get the required arguments schema for an MCP tool before calling/invoking it.",
      parameters: {
        type: "object",
        properties: {
  ...
  },
  {
    schema: {
      name: "call_mcp_tool",
      description: "Call/invoke an MCP tool by its name and provide arguments as a JSON string. Make sure you use get_mcp_tool_schema first to know what arguments are expected.",
      parameters: {
        type: "object",
        properties: {
